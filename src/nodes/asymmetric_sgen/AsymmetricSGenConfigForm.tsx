...
type AsymmetricSGenConfigFormProps = {
  value: AsymmetricSGenData;
  onSubmit: (next: AsymmetricSGenData) => void;
};

export const AsymmetricSGenConfigForm = ({ value, onSubmit }: AsymmetricSGenConfigFormProps) => {
  return (
    <Form
      layout="vertical"
      size="small"
      initialValues={value}
      onFinish={(values) => {
        onSubmit(values as AsymmetricSGenData);
      }}
    >
